                           ...
                           const Point& v2, Point& nearest_point)
{
    ...
    if (std::fabs(d) < std::numeric_limits<Scalar>::min())
    {
        Point q, qq;
